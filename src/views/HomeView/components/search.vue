<template>
    <header class="flex justify-between relative">
        ...
        <svg @click="serachHand" class=" absolute top-[50%] left-[17%] -translate-y-2/4" xmlns="http://www.w3.org/2000/svg"
            width="24" height="24" viewBox="0 0 24 24">
            <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="m21 21l-4.343-4.343m0 0A8 8 0 1 0 5.343 5.343a8 8 0 0 0 11.314 11.314Z" />
        </svg>
        <input type="text" :placeholder="searchName" v-model="searchKeywords"
        ...
        <ul v-if="userSearchKeywords"
            class="w-[100%] bg-white absolute bottom-0 translate-y-[100%] overflow-hidden rounded-xl z-10">
            <li class="text-center bg-gradient-to-r from-pink-500 to-purple-500 " v-for="item in defaultResult"
...
<script>
export default {
    props: ['userSearchKeywords', 'serachHandler', 'defaultResult', 'searchName'],
    data() {
        return {
